...
file copy -force ../../ref/lattice/lfcpnx_rpi/dp_rpi_app_rom.mem ./dp_app_rom_lat/.
file copy -force ../../ref/lattice/lfcpnx_rpi/dp_app_rom_lat.ipx ./dp_app_rom_lat/.
file copy -force ../../ref/lattice/lfcpnx_rpi/dp_app_rom_lat.cfg ./dp_app_rom_lat/.
prj_add_source ./dp_app_rom_lat/dp_app_rom_lat.ipx

# Application RAM
file mkdir ./dp_app_ram_lat
file copy -force ../../ref/lattice/lfcpnx_rpi/dp_rpi_app_ram.mem ./dp_app_ram_lat/.
file copy -force ../../ref/lattice/lfcpnx_rpi/dp_app_ram_lat.ipx ./dp_app_ram_lat/.
file copy -force ../../ref/lattice/lfcpnx_rpi/dp_app_ram_lat.cfg ./dp_app_ram_lat/.
